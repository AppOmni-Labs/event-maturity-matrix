# Salesforce - Real-Time Event Monitoring LogoutEventStream (1.0.0)
...
| -------- | ---------- | ---------- | -------- |
| C0001 | ET0002 |A0001 -> EventDate<br />A0002 -> EventIdentifier<br />A0003 -> data.payload.attributes.type<br />A0005 -> Username<br />A0006 -> UserId<br />A0008 -> SessionKey<br />A0009 -> SourceIp<br />|[success](/products/salesforce/event_examples/salesforce_rtem_logouteventstream/authentication_account_logout.json)<br />|
