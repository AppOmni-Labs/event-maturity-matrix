# Salesforce - EventLogFile Unique Query Event Type (1.0.0)
...
| -------- | ---------- | ---------- | -------- |
| C0004 | ET0035 |A0001 -> TIMESTAMP_DERIVED<br />A0003 -> EVENT_TYPE<br />A0006 -> USER_ID<br />A0008 -> SESSION_KEY<br />A0033 -> QUERY_IDENTIFIER<br />|[success](/products/salesforce/event_examples/salesforce_elf_unique_query_event/activity_audit_query_resource_elf_uniquequery.json)<br />|
