...
## Read User Activities API (get_read_user_activities) Collection

The PingOne Read User Activities API provides near real-time, read-only access to an organization's audit activity events.

### Read User Activities API Documentation (get_read_user_activities_documentation) Reference

API documentationURL Reference: [https://apidocs.pingidentity.com/pingone/platform/v1/api/#get-read-user-activities](https://apidocs.pingidentity.com/pingone/platform/v1/api/#get-read-user-activities)
