...
| Authentication | Account Logout | [success](/products/okta/event_examples/authentication_account_logout.json) | Timestamp=2023-09-14T16:24:24.572Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.session.end; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authentication | MFA Verification | [success](/products/okta/event_examples/authentication_mfa_verification.json) | Timestamp=2023-09-14T19:20:47.234Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.authentication.auth_via_mfa; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authentication | MFA Verification | [flagged](/products/okta/event_examples/authentication_mfa_verification_flagged.json) | Timestamp=2023-09-14T19:07:28.185Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.account.report_suspicious_activity_by_enduser; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Create User | [success](/products/okta/event_examples/authorization_create_user.json) | Timestamp=2023-09-14T20:18:47.825Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.lifecycle.create; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Update User | [success](/products/okta/event_examples/authorization_update_user.json) | Timestamp=2023-09-14T20:20:05.557Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.account.update_profile; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Delete User | [success](/products/okta/event_examples/authorization_delete_user.json) | Timestamp=2023-09-14T20:21:30.151Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.lifecycle.delete.initiated; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Create Group | [success](/products/okta/event_examples/authorization_create_group.json) | Timestamp=2023-09-14T18:58:09.243Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=group.lifecycle.create; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Update Group | [success](/products/okta/event_examples/authorization_update_group.json) | Timestamp=2023-09-14T20:22:38.036Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=group.application_assignment.add; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Delete Group | [success](/products/okta/event_examples/authorization_delete_group.json) | Timestamp=2023-09-14T20:23:26.473Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=group.lifecycle.delete; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Add To Group | [success](/products/okta/event_examples/authorization_add_to_group.json) | Timestamp=2023-09-14T20:26:40.529Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=group.user_membership.add; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Remove From Group | [success](/products/okta/event_examples/authorization_remove_from_group.json) | Timestamp=2023-09-14T20:27:00.112Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=group.user_membership.remove; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Create Role | [success](/products/okta/event_examples/authorization_create_role.json) | Timestamp=2023-09-14T20:32:05.713Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=iam.role.create; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Update Role | [success](/products/okta/event_examples/authorization_update_role.json) | Timestamp=2023-09-14T20:32:28.571Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=iam.role.permissions.delete; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Delete Role | [success](/products/okta/event_examples/authorization_delete_role.json) | Timestamp=2023-09-14T20:32:33.316Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=iam.role.delete; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Add Permission | [success](/products/okta/event_examples/authorization_add_permission.json) | Timestamp=2023-09-14T20:26:40.657Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.account.privilege.grant; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Remove Permission | [success](/products/okta/event_examples/authorization_remove_permission.json) | Timestamp=2023-09-14T20:27:00.236Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.account.privilege.revoke; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Add Enrollment | [success](/products/okta/event_examples/authorization_add_enrollment.json) | Timestamp=2023-09-14T19:09:25.749Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.mfa.factor.activate; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Authorization | Remove Enrollment | [success](/products/okta/event_examples/authorization_remove_enrollment.json) | Timestamp=2023-09-14T15:49:03.007Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=user.mfa.factor.deactivate; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| System Audit | Create Security Configuration | [success](/products/okta/event_examples/system_audit_create_security_configuration_idp.json) | Timestamp=2023-09-14T20:33:22.575Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=system.idp.lifecycle.create; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| System Audit | Update Security Configuration | [success](/products/okta/event_examples/system_audit_update_security_configuration_zone.json) | Timestamp=2023-09-12T01:40:39.219Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=zone.update; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| System Audit | Delete Security Configuration | [success](/products/okta/event_examples/system_audit_delete_security_configuration_behavior.json) | Timestamp=2023-09-14T20:34:41.030Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=security.behavior.settings.delete; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| System Audit | Create Integration | [success](/products/okta/event_examples/system_audit_create_integration.json) | Timestamp=2023-09-14T20:37:50.674Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=application.lifecycle.create; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| System Audit | Update Integration | [success](/products/okta/event_examples/system_audit_update_integration.json) | Timestamp=2023-09-14T20:39:48.184Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=application.lifecycle.update; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| System Audit | Delete Integration | [success](/products/okta/event_examples/system_audit_delete_integration.json) | Timestamp=2023-09-14T20:38:09.948Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=application.lifecycle.delete; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Activity Audit | Create Resource | [success](/products/okta/event_examples/activity_audit_create_resource.json) | Timestamp=2023-09-14T15:00:54.589Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=system.api_token.create; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Activity Audit | Update Resource | [success](/products/okta/event_examples/activity_audit_update_resource.json) | Timestamp=2023-09-19T20:41:41.654Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=policy.rule.update; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Activity Audit | Delete Resource | [success](/products/okta/event_examples/activity_audit_delete_resource.json) | Timestamp=2023-09-18T19:16:16.459Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=workflows.user.flow.delete; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
| Activity Audit | Download Resource | [success](/products/okta/event_examples/activity_audit_download_resource.json) | Timestamp=2023-09-14T17:45:28.879Z; Event ID=11111111-2222-3333-4444-abcdef111111111111; Event Code / Type=analytics.reports.export.download; Username=alice@example.com; User ID=00ua1aaaa1abc0A0B123 |
