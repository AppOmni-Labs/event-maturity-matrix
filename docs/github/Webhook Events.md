...
| C0004 | ET0030 |A0003 -> action<br />A0005 -> sender.login<br />A0006 -> sender.id<br />A0007 -> sender.type<br />A0030 -> repository.name<br />A0031 -> X-GitHub-Event<br />|[success](/products/github/event_examples/webhook/activity_audit_create_resource_repo.json)<br />|
| C0004 | ET0033 |A0003 -> action<br />A0005 -> sender.login<br />A0006 -> sender.id<br />A0007 -> sender.type<br />A0030 -> repository.name<br />A0031 -> X-GitHub-Event<br />|[success](/products/github/event_examples/webhook/activity_audit_delete_resource_repo.json)<br />|
