...
| -------- | ---------- | ---------- | -------- |
| C0001 | ET0001 |A0001 -> created_at<br />A0002 -> _document_id<br />A0003 -> action<br />A0005 -> actor<br />A0006 -> actor_id<br />A0010 -> actor_location.country_code<br />A0011 -> user_agent<br />A0014 -> action<br />A0015 -> issuer<br />|[success](/products/github/event_examples/audit/authentication_account_login.json)<br />|
...
| C0002 | ET0011 |A0001 -> created_at<br />A0002 -> _document_id<br />A0003 -> action<br />A0005 -> actor<br />A0006 -> actor_id<br />A0009 -> actor_ip<br />A0010 -> actor_location.country_code<br />A0011 -> user_agent<br />A0021 -> ['org', 'team']<br />|[success](/products/github/event_examples/audit/authorization_delete_group_team.json)<br />|
...
| C0003 | ET0024 |A0001 -> created_at<br />A0002 -> _document_id<br />A0003 -> action<br />A0005 -> actor<br />A0006 -> actor_id<br />A0009 -> actor_ip<br />A0010 -> actor_location.country_code<br />A0011 -> user_agent<br />A0026 -> name<br />A0027 -> config<br />A0028 -> config_was<br />|[success](/products/github/event_examples/audit/system_audit_update_security_configuration_hook_config.json)<br />[success](/products/github/event_examples/audit/system_audit_update_security_configuration_merge_setting.json)<br />|
...
| C0003 | ET0029 |A0001 -> created_at<br />A0002 -> _document_id<br />A0003 -> action<br />A0005 -> actor<br />A0006 -> actor_id<br />A0009 -> actor_ip<br />A0010 -> actor_location.country_code<br />A0011 -> user_agent<br />A0029 -> integration<br />|[success](/products/github/event_examples/audit/system_audit_delete_integration.json)<br />|
