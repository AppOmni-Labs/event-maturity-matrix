...
## Retrieve Audit Details API (get_audittrail_api) Collection

The Veeva Vault Retrieve Audit Details API provides near real-time, read-only access to an organization's audit log.

### Retrieve Audit Details API Documentation (get_api_logs) Reference

API documentationURL Reference: [https://developer.veevavault.com/api/24.1/#retrieve-audit-details](https://developer.veevavault.com/api/24.1/#retrieve-audit-details)
